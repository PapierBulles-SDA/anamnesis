...
const TrouveTonVerset = {
            ...
            <div class="verset-quiz-container choix-parcours">
                ...
                <div class="parcours-grid">
                    <button class="parcours-card" data-parcours="trinite">
                        ...
                        <div class="parcours-card-time">~30s</div>
                    </button>
                    ...
                    <button class="parcours-card" data-parcours="plenitude">
                        ...
                        <div class="parcours-card-time">~1min30</div>
                    </button>
                </div>
    ...
    showResult() {
        ...
        // Scroller vers le haut pour voir le résultat complet
        // Utiliser setTimeout pour s'assurer que le DOM est rendu
        setTimeout(() => {
            overlay.scrollTo({ top: 0, behavior: 'instant' });
            // Alternative : scroller le container dans la vue
            const container = overlay.querySelector('.verset-quiz-container');
            if (container) {
    ...
    injectParcoursStyles() {
        ...
        styles.textContent = `
            /* ═══════════════════════════════════════════════════════════════ */
            /* FIX CRITICAL: Forcer l'affichage depuis le HAUT                 */
            /* Override du align-items: center de styles.css                   */
            /* ═══════════════════════════════════════════════════════════════ */
            ...
            .verset-quiz-container {
                margin-top: 10px;
                margin-bottom: 20px;
            }

            /* Fix bouton fermeture - centrer la croix */
            .quiz-close-btn {
            ...
            /* ═══════════════════════════════════════════════════════════════ */
            /* ÉCRAN CHOIX PARCOURS (NOUVEAU)                                  */
            /* Adapté au thème sombre existant                                 */
            /* ═══════════════════════════════════════════════════════════════ */
            
            .verset-quiz-container.choix-parcours {
            ...
            /* ═══════════════════════════════════════════════════════════════ */
            /* BADGE PARCOURS (dans accueil et résultat)                       */
            /* ═══════════════════════════════════════════════════════════════ */
            ...
            /* ═══════════════════════════════════════════════════════════════ */
            /* RÉSULTAT AVEC 2 VERSETS (parcours Plénitude)                    */
            /* ═══════════════════════════════════════════════════════════════ */
            ...
            .verset-card.compact .verset-text {
                font-size: 1.1em;
            }
            ...
            /* ═══════════════════════════════════════════════════════════════ */
            /* MODAL HISTORIQUE (superposition)                                */
            /* ═══════════════════════════════════════════════════════════════ */
